<template>
    <ClientOnly>
        <v-app class="l-content_wrap" :class="{ 'p-dashboard': isLoggedIn, 'p-login': !isLoggedIn && !preview_token }">
            <v-navigation-drawer v-if="authUser.member_id || preview_token" id="c-navi_side" v-model="drawer" left fixed dark permanent>
            ...
            <v-app-bar :clipped-left="clipped" color="#1414A0" dense dark app class="l-header_toolbar">
                ...
                <template v-else>
                    ...
                    <div v-else-if="!preview_token" class="white--text">
...
const preview_token = router.currentRoute.value.query?.preview_token;
