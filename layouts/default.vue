<template>
  <ClientOnly>
    <v-app
      ...
      :class="{ 'p-dashboard': isLoggedIn, 'p-login': !isLoggedIn }"
    >
      <v-navigation-drawer
      ...
      >
        <div class="text-center py-4">
          <a href="/">
            <img
              src="~/assets/images/logo.png?width=150"
              class="c-navi_side-logo"
            />
          </a>
        </div>
        <v-list>
          ...
          >
            ...
            <v-list-item-title
              v-text="
                authUser.member_id && item.titleLoggedIn
                  ? item.titleLoggedIn
                  : item.title
              "
            />
      ...
      <v-footer color="#1414A0" padless>
        <v-row justify="center" no-gutters class="pt-3">
          <a href="https://github.com/diverta/front_nuxt_auth"
            ><small class="my-4 pt-3 l-footer_copyright"
              >Github repository</small
            ></a
          >
          <a href="https://kuroco.app/"
            ><img
              src="~/assets/images/logo-kuroco.svg"
              width="120"
              class="pl-4 l-footer_logo"
          /></a>
