    ...
    async mounted() {
        ...
        try {
            if (response.data.details.hasOwnProperty('name1')) {
                this.schema.fields[0].text = response.data.details.name1;
            }
            if (response.data.details.hasOwnProperty('name2')) {
                this.schema.fields[1].text = response.data.details.name2;
            }
            if (response.data.details.hasOwnProperty('birth')) {
                this.schema.fields[3].text = response.data.details.birth;
            }
            if (response.data.details.hasOwnProperty('department')) {
                this.schema.fields[4].text = response.data.details.department;
            }
            if (response.data.details.hasOwnProperty('position')) {
                this.schema.fields[5].text = response.data.details.position;
            }
            if (response.data.details.hasOwnProperty('tel')) {
                this.schema.fields[6].text = response.data.details.tel;
            }
            if (response.data.details.hasOwnProperty('email')) {
                this.schema.fields[7].text = response.data.details.email;
            }
            if (response.data.details.hasOwnProperty('notes')) {
                this.schema.fields[13].text = response.data.details.notes;
            }
            this.schema.fields[9].text = response.data.details.address1;
